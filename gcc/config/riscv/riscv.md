...
(define_insn "addsi3"
  ...
  ""
  { return (TARGET_64BIT || TARGET_128BIT) ? "add%i2w\t%0,%1,%2" : "add%i2\t%0,%1,%2"; }
  [(set_attr "type" "arith")
   (set_attr "mode" "SI")])
...
(define_insn "subsi3"
  ...
  ""
  { return (TARGET_64BIT || TARGET_128BIT) ? "subw\t%0,%z1,%2" : "sub\t%0,%z1,%2"; }
  [(set_attr "type" "arith")
   (set_attr "mode" "SI")])
...
(define_insn "negsi2"
  ...
  ""
  { return (TARGET_64BIT || TARGET_128BIT) ? "negw\t%0,%1" : "neg\t%0,%1"; }
  [(set_attr "type" "arith")
   (set_attr "mode" "SI")])
...
(define_insn "mulsi3"
  [(set (match_operand:SI          0 "register_operand" "=r")
	(mult:SI (match_operand:SI 1 "register_operand" " r")
		 (match_operand:SI 2 "register_operand" " r")))]
  "TARGET_MUL"
  { return (TARGET_64BIT || TARGET_128BIT) ? "mulw\t%0,%1,%2" : "mul\t%0,%1,%2"; }
  [(set_attr "type" "imul")
   (set_attr "mode" "SI")])
...
(define_insn "muldi3"
  [(set (match_operand:DI          0 "register_operand" "=r")
	(mult:DI (match_operand:DI 1 "register_operand" " r")
		 (match_operand:DI 2 "register_operand" " r")))]
  "TARGET_MUL && (TARGET_64BIT || TARGET_128BIT)"
  { return TARGET_128BIT ? "muld\t%0,%1,%2" : "mul\t%0,%1,%2"; }
  [(set_attr "type" "imul")
   (set_attr "mode" "DI")])
...
(define_insn "<optab>si3"
  [(set (match_operand:SI             0 "register_operand" "=r")
	(any_div:SI (match_operand:SI 1 "register_operand" " r")
		    (match_operand:SI 2 "register_operand" " r")))]
  "TARGET_DIV"
  { return (TARGET_64BIT || TARGET_128BIT) ? "<insn>%i2w\t%0,%1,%2" : "<insn>%i2\t%0,%1,%2"; }
  [(set_attr "type" "idiv")
   (set_attr "mode" "SI")])
...
(define_insn_and_split "*<optab>ti3_mask"
  [(set (match_operand:TI     0 "register_operand" "= r")
	(any_shift:TI
	    (match_operand:TI 1 "register_operand" "  r")
	    (match_operator 4 "subreg_lowpart_operator"
	     [(and:SI
	       ...
	       (match_operand 3 "const_int_operand"))])))]
  "TARGET_128BIT
   && (INTVAL (operands[3]) & (GET_MODE_BITSIZE (TImode)-1))
       == GET_MODE_BITSIZE (TImode)-1"
  "#"
  "&& 1"
  [(set (match_dup 0)
	(any_shift:TI (match_dup 1)
		      (match_dup 2)))]
  "operands[2] = gen_lowpart (QImode, operands[2]);"
  [(set_attr "type" "shift")
   (set_attr "mode" "TI")])

(define_insn_and_split "*<optab>ti3_mask_1"
  [(set (match_operand:TI     0 "register_operand" "= r")
	(any_shift:TI
	    (match_operand:TI 1 "register_operand" "  r")
	    (match_operator 4 "subreg_lowpart_operator"
...
(define_expand "f<quiet_pattern>_quiet<ANYF:mode><XIF:mode>4"
   [(parallel [(set (match_operand:XIF      0 "register_operand")
		    (unspec:XIF
		     [(match_operand:ANYF 1 "register_operand")
		      (match_operand:ANYF 2 "register_operand")]
		     QUIET_COMPARISON))
	       (clobber (match_scratch:XIF 3))])]
  "TARGET_HARD_FLOAT")

(define_insn "*f<quiet_pattern>_quiet<ANYF:mode><XIF:mode>4_default"
   [(set (match_operand:XIF      0 "register_operand" "=r")
	 (unspec:XIF
	  [(match_operand:ANYF 1 "register_operand" " f")
	   (match_operand:ANYF 2 "register_operand" " f")]
	  QUIET_COMPARISON))
    (clobber (match_scratch:XIF 3 "=&r"))]
...
(define_insn "*f<quiet_pattern>_quiet<ANYF:mode><XIF:mode>4_snan"
   [(set (match_operand:XIF      0 "register_operand" "=r")
	 (unspec:XIF
	  [(match_operand:ANYF 1 "register_operand" " f")
	   (match_operand:ANYF 2 "register_operand" " f")]
